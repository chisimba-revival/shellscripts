...
# Author: Derek Keats
#
# contextCondition::init() overrides condition::init($tableName = null,
# $pearDb = null, $errorCallback = 'globalPearErrorCallback').
# PHP 8 requires the child declaration to accept a compatible parameter list.
# The existing context-condition initialization body remains unchanged.
...
TARGET="$1/core_modules/contextpermissions/classes/contextcondition_class_inc.php"
[[ -f "$TARGET" ]] || exit 0
